...
class Buildbench_Instagram extends WP_Widget
{
    function __construct() {

        $widget_opt = array(
            'classname'     => 'buildbench-widget',
            'description'   => 'buildbench instagrams'
        );
        
        parent::__construct('buildbench-instagram', esc_html__('buildbench instagram', 'buildbench'), $widget_opt);
    }
    ...
    function form($instance){
        ...
        $user_id = '';
        $media_count = 10;
        $title = esc_html__( 'Instagram', 'buildbench' );
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e( 'Title:', 'buildbench' ); ?></label>
        ...
        <p>
            ...
            <?php esc_html__( 'Log in and get my Access Token and User ID' , 'buildbench' ); ?>
            </a>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'access_token' )); ?>"><?php esc_html__( 'Access token:' , 'buildbench' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'user_id' )); ?>"><?php esc_html__( 'User ID:' , 'buildbench' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'media_count' )); ?>"><?php esc_html__( 'Count:' , 'buildbench' ); ?></label>
