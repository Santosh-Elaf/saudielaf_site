 ...
 * twitter feed widget
 */
class Buildbench_Twitter_Feed extends WP_Widget {

    function __construct() {
        $widget_opt = array(
            'classname'		 => 'buildbench-twitter-feed',
            'description'	 => esc_html__('buildbench twitter feed','buildbench')
        );

        parent::__construct( 'xs-twitter-feed', esc_html__( 'Buildbench twitter feed', 'buildbench' ), $widget_opt );
    }
    ...
    function widget( $args, $instance ) {
        ...
        $username			 = '';
        $loading_text = esc_html__('Loading!','buildbench');
    ...
    function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Twitter feed', 'buildbench' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'Username:', 'buildbench' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'loading_text' ) ); ?>"><?php esc_html_e( 'Loading text:', 'buildbench' ); ?></label>
