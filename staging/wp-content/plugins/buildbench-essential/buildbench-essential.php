<?php
/*
* Plugin Name: Buildbench Essentials
* License - GNU/GPL V2 or Later
* Description: This is a required plugin for Buildbench theme.
* Version: 1.2
* text domain: buildbench-essntial
*/
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
...
// Add language
add_action( 'init', 'buildbench_language_load' );
function buildbench_language_load(){
    $plugin_dir = basename(dirname(__FILE__))."/languages/";
    load_plugin_textdomain( 'buildbench-essntial', false, $plugin_dir );
}

// main class
class Buildbench_Essentials_Includes {
	...
	public static function include_widget( $widget_dir ) {
		...
		register_widget( 'Buildbench_' . self::dirname_to_classname( $widget_dir ) );
	}
	...
	public static function _action_init() {
        ...
        self::include_isolated( self::get_path('/settings/controls-projects.php') );
        self::include_isolated( self::get_path('/settings/controls-service.php') );
        self::include_isolated( self::get_path('/settings/controls-team.php') );
    }
}

Buildbench_Essentials_Includes::init();